...
protected override void OnModelCreating(ModelBuilder modelBuilder)
    ...
    modelBuilder.Entity<FailedLoginAttempt>(entity =>
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.Property(e => e.NotTriggeredBy).HasColumnName("notTriggeredBy");
            ...
            entity.HasOne(d => d.NotTriggeredByNavigation).WithMany(p => p.Notifications)
                .HasForeignKey(d => d.NotTriggeredBy)
                .HasConstraintName("FK__Notificat__notTr__30F848ED");
        });
